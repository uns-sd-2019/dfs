...
.PHONY: clean
clean :
	rm shell coordinador Coordinador_clnt.c Coordinador_svc.c Coordinador.h Nodo_xdr.c Nodo_clnt.c Nodo_svc.c Nodo.h nodo
...
coordinador: coordinador.c Coordinador_svc.c Coordinador.h operacionesTabla.c
	gcc -lnsl -o coordinador coordinador.c Coordinador_svc.c Coordinador.h operacionesTabla.c
